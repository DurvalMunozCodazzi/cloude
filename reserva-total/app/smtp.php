<?php
// Envío de email por SMTP — compartido entre notifications.php (comprobantes)
// y auth.php (recuperación de contraseña). Usa la configuración guardada en
// rt_settings (Ajustes → Email dentro de la app).
