...
class RTLS_License {
    ...
    // Generate a unique license key: RT-XXXX-XXXX-XXXX-XXXX
    ...
    public static function create(array $data): int|false {
        ...
        $row = [
            ...
            'plan'           => $plan,
            'status'         => 'active',
            'max_resources'  => (int)($data['max_resources'] ?? $caps['max_resources']),
    ...
    public static function update(int $id, array $data): bool {
        ...
        $allowed = ['customer_name','customer_email','domain','plan','status','max_resources','expires_at','notes'];
        $update  = [];
        ...
        if (isset($update['plan'])) {
            ...
            if (!isset($data['max_resources'])) $update['max_resources'] = $caps['max_resources'];
        }
    ...
    public static function verify(string $key, string $domain): array {
        ...
        $sig = '';
        $private_pem = get_option('rtls_private_key', '');
        if ($private_pem) {
        ...
        return [
            ...
            'issued_at'     => $issued_at,
            'max_resources' => (int) $lic['max_resources'],
            'sig'           => $sig,
        ];
    }
